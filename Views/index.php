...
<head>
    ...
    <title>Shofy -The best multipurpose eCommerce</title>
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1">

    <!-- Place favicon.ico in the root directory -->
    <link rel="shortcut icon" type="image/x-icon" href="assets/img/logo/OUSS.png">
...
<body>
            ...
            <div id="loading-center-absolute">
                ...
                <div class="tp-preloader-content">
                    <div class="tp-preloader-logo">
                        ...
                        <img src="assets/img/logo/OUSS.png" alt="">
                    </div>
                    <h3 class="tp-preloader-title">OUSSAMA</h3>
            ...
            <div class="offcanvas__content">
                <div class="offcanvas__top mb-70 d-flex justify-content-between align-items-center">
                    <div class="offcanvas__logo logo">
                        <a href="index.html">
                        <img src="assets/img/logo/OUSS.png" alt="logo">
                     </a>
                    </div>
                </div>
                                    ...
                                    <nav class="tp-category-menu-content">
                                        <ul>
                                         ...
                                         Cameras</a>
                                            ...
                                            <li>
                                                <a href="http://localhost/tama1/Views/ajouterProduit.php">
                                         <span>
                                            <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <main>
        ...
        <?php
                         foreach ($listproduitC as $produit) {
                          ?>
