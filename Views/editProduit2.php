...
include_once '../Controller/Produit2C.php';
...
if(isset($_GET['id'])) {
    ...
    $id = $_GET['id'];
    $produit2 = $produit2C->recupererproduit2($id);
    ...
    if($produit2) {
        ...
        if($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if (move_uploaded_file($_FILES["register-image"]["tmp_name"], $target_file)) {
                ...
                $produit2C->modifierproduit2($id, $nom, $prix, $image_name);
                
                // Redirect to afficherProduit2.php after updating
...
<body>
    <div class="container">
        ...
        <form method="POST" action="" enctype="multipart/form-data">
            ...
            <input type="text" id="nom" name="nom" value="<?php echo $produit2['nom']; ?>">
            
            <label for="prix">Prix:</label>
            <input type="text" id="prix" name="prix" value="<?php echo $produit2['prix']; ?>">
